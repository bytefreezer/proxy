...
import (
	...
	_ "github.com/bytefreezer/proxy/plugins/http"
	_ "github.com/bytefreezer/proxy/plugins/ipfix"
	_ "github.com/bytefreezer/proxy/plugins/kafka"
	_ "github.com/bytefreezer/proxy/plugins/kinesis"
	_ "github.com/bytefreezer/proxy/plugins/nats"
	_ "github.com/bytefreezer/proxy/plugins/netflow"
	_ "github.com/bytefreezer/proxy/plugins/sflow"
	_ "github.com/bytefreezer/proxy/plugins/sqs"
	_ "github.com/bytefreezer/proxy/plugins/syslog"
	_ "github.com/bytefreezer/proxy/plugins/udp"
)
...
func main() {
	...
	if cfg.HealthReporting.Enabled && cfg.ControlURL != "" {
		...
		go func() {
			...
			if err := selfUpgrade("proxy", tag); err != nil {
...
func selfUpgrade(repoName, tag string) error {
	// Strip "v" prefix from tag to get version (e.g., "v1.0.0-rc.0226" → "1.0.0-rc.0226")
