#!/bin/bash
# DEPRECATED: This script generates malformed sFlow data and is kept for reference only
#
# For REAL sFlow v5 testing, use one of these instead:
#   - fake_feeds/sflow_generator.py  (Python script with proper binary sFlow v5)
#   - fake_feeds/test_sflow.sh       (Shell wrapper for sflow_generator.py)
#
# The data generated by this script does NOT conform to sFlow v5 specification
# and will fail to decode with standards-compliant parsers like goflow2.

echo "WARNING: This script is DEPRECATED"
echo ""
echo "This script generates malformed sFlow data that does not conform to the sFlow v5 specification."
echo ""
echo "For real sFlow testing, use:"
echo "  python3 fake_feeds/sflow_generator.py --host localhost --port 2066 --rate 10 --duration 5"
echo "  OR"
echo "  ./fake_feeds/test_sflow.sh localhost 2066 10 5"
echo ""
echo "Exiting..."
exit 1
